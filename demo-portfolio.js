...
document.addEventListener('DOMContentLoaded', () => {
    const ctx = document.getElementById('demoPortfolioChart').getContext('2d');
    const demoPortfolioChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ['10:00', '10:15', '10:30', '10:45', '11:00', '11:15'],
            datasets: [{
                label: 'Demo Portfolio Value',
                data: [1200, 1220, 1235, 1245, 1240, 1245],
                borderColor: '#7c3aed',
                tension: 0.4,
                fill: false,
                pointRadius: 4,
...
document.querySelector('.btn-add-asset').addEventListener('click', () => {
    alert('Opening Demo Asset Adder... 💼');
});

// AI Chat
document.querySelector('.btn-chat').addEventListener('click', () => {
    alert('AI Assistant: Want to optimize your demo portfolio? Ask me! 🤖');
});
